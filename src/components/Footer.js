    ...
    <Card bg="dark" className="text-center card-footer">
      ...
      <Card.Body className="social-links">
        <Card.Text>
          ...
          <a href="https://instagram.com/adityakahanhai_?igshid=ZmZhODViOGI=">
            Instagram
          </a>
        ...
        <Button variant="light">
          Connect with me on my social media platforms or send me a mail on
          @adityasharma08official@gmail.com
        </Button>
      </Card.Body>
