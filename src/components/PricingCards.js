      ...
      <CardGroup>
        <Card className="cards" bg="dark" style={{ width: "18rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              Fuzzy Clustering Visualizer is a web app for visualizing a bunch
              of different sorting algorithms.
            </Card.Text>
            <Button
              href="https://adisince2002.github.io/fuzzy-k-Clustering/"
              variant="warning"
            >
              Visit Web App
            </Button>
        ...
        <Card className="cards" bg="dark" style={{ width: "18rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              Tindog is an online dating and geosocial networking
              application for dogs.
            </Card.Text>
            <Button
              href="https://adisince2002.github.io/tindog/"
              variant="warning"
            >
              Visit Web App
            </Button>
        ...
        <Card className="cards" bg="dark" style={{ width: "18rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              Landing Page of an E-Commerce website. I've worked on sliding
              images of promotional products.
            </Card.Text>
            <Button
              href="https://adisince2002.github.io/Flipkart-Landing-Page/"
              variant="warning"
            >
              Visit Web App
            </Button>
